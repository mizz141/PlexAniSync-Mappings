...
| Monogatari | Series and Movies  | S00, S01, S02, S03, S04, S05  | ***yes***  | S00 for Specials is only a placeholder due to PlexAniSync not recognizing Specials, will get updated when a fix is found. |
